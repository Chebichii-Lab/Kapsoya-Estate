from kapsoya.models import Business, Neighbourhood, Profile
...
# Set up method
    def setUp(self):
        ...
        self.user.save()
        self.neighbourhood= Neighbourhood(neighbourhood_name = "kapseret", neighbourhood_location= "Eldoret", admin = self.user, neighbourhood_description='hood of hoods')
        self.neighbourhood.save()
        self.profile = Profile(bio='my hood',email='email@gmail.com', id_number=36677889,user = self.user, neighbourhood = self.neighbourhood)
